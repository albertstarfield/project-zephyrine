...
https://firstdonoharm.dev/version/3/0/bds-bod-media-mil-soc-sup-sv.txt
 ...
 * 3.1. The Licensee SHALL NOT, whether directly or indirectly, through agents
   ...
   * 3.1.10. Forcibly remove indigenous peoples from their lands or territories
    ...
    * 3.1.12. Mass Surveillance: Be a government agency or multinational
    ...
    * 3.1.13. Military Activities: Be an entity or a representative, agent,
      affiliate, successor, attorney, or assign of an entity which conducts
      military activities;
   
    * 3.1.14. Media: Be an individual or entity, or a representative, agent,
   ...
   * 3.1.15. Interfere with Workers’ free exercise of the right to organize and
   ...
   * 3.1.16. Harm the environment in a manner inconsistent with local, state,
