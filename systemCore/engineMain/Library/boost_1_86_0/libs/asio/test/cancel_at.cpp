...
(
  "cancel_at",
  BOOST_ASIO_TEST_CASE(cancel_at_function_object_test)
  BOOST_ASIO_TEST_CASE(cancel_at_timer_function_object_test)
  BOOST_ASIO_TEST_CASE(cancel_at_completion_token_v1_test)
  BOOST_ASIO_TEST_CASE(cancel_at_timer_completion_token_v1_test)
  BOOST_ASIO_TEST_CASE(cancel_at_completion_token_v2_test)
  BOOST_ASIO_TEST_CASE(cancel_at_timer_completion_token_v2_test)
