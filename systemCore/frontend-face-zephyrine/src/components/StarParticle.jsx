...
// The SVG content for a single star particle
// Attribution: Vectors and icons by Solar Icons in CC Attribution License via SVG Repo
const StarSVG = (props) => (
  ...
  return (
    <div
      ...
      style={{
        top: `${top}vh`,
        left: `${left}vw`,
        animation: `pop-oscillate-fade 8s ease-in-out infinite`,
