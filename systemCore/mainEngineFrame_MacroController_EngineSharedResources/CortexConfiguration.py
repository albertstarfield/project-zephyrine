...
)  # Assumes config.py is in mainEngineFrame_MacroController_EngineSharedResources
...
DCTD_SOCKET_PATH = "./celestial_timestream_vector_helper.socket"  # Relative to systemCore/mainEngineFrame_MacroController_EngineSharedResources
...
MODULE_DIR = os.path.dirname(__file__)
# Or, if config.py is in mainEngineFrame_MacroController_EngineSharedResources and file_indexer.py is also there:
