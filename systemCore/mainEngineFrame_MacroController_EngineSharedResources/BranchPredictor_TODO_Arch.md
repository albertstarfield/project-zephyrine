...
**File:** `systemCore/mainEngineFrame_MacroController_EngineSharedResources/BranchPredictor_DCTD_PyEmbed_TODO.md`
...
1.  [ ] **Create `requirements.txt`:**
    *   Location: `systemCore/mainEngineFrame_MacroController_EngineSharedResources/branchpredictor_dctd/python_env/`
    *   Content:
        ```text
        numpy>=1.23.0
        qiskit>=1.0.0
...
2.  [ ] **Create the Quantum Logic Script (`oracle.py`):**
    *   Location: `systemCore/mainEngineFrame_MacroController_EngineSharedResources/branchpredictor_dctd/src/py/oracle.py`
...
1.  [ ] **Update `launcher.py` (Setup Sequence):**
    ...
    *   Command: `pip install -r systemCore/mainEngineFrame_MacroController_EngineSharedResources/branchpredictor_dctd/python_env/requirements.txt`
