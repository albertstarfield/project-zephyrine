...
const EditIcon = () => (
  <svg
    ...
    width="16"
    height="16"
    className="sidebar-action-icon edit-icon"
  >
...
const DeleteIcon = () => (
  <svg
    ...
    width="16"
    height="16"
    className="sidebar-action-icon delete-icon"
  >
    <path
      fillRule="evenodd"
...
const CheckIcon = () => (
  <svg
    ...
    width="16"
    height="16"
    className="sidebar-action-icon confirm-icon"
  >
    <path
      fillRule="evenodd"
...
const CancelIcon = () => (
  <svg
    ...
    width="16"
    height="16"
    className="sidebar-action-icon cancel-icon"
  >
    <path
      fillRule="evenodd"
...
const SideBar = ({
  ...
  const handleInfoClick = () => {
    setInfoModalMessage(
      "This setting is accessible from the config.py backend (Not the Frontend Backend) or the systemCore/mainEngineFrame_MacroController_EngineSharedResources itself! It is not a standard on openAI API. Thank you",
    );
  };
  ...
  const handleInputBlur = (chatId) => {
    setTimeout(() => {
      if (editingChatId === chatId) handleRename(chatId);
    }, 100);
  };
    ...
    <>
      ...
      >
        ...
        <div className="sidebar-top-actions">
          ...
          ) /* Show only if not collapsed visually */ && (
        ...
        <nav className="sidebar-history">
          {!(isCollapsed && !isHovering) && <h4>History</h4>}{" "}
          {/* Show only if not collapsed visually */}
          <ul>
            {(chats || []).map((chat) => (
              <li
                ...
                className={`history-item ${editingChatId === chat.id ? "editing" : ""} ${chat.id === currentChatId ? "active" : ""}`}
              >
                {editingChatId === chat.id ? (
                  ...
                  <Link to={`/chat/${chat.id}`} className="history-item-button">
                    ...
                    {!(
                      isCollapsed && !isHovering
                    ) /* Show actions only if not collapsed visually */ && (
        ...
        <div className="sidebar-bottom-actions">
          <Link
            to="/"
            className="sidebar-button MainPageChat"
            title={isCollapsed ? "MainPageChat" : ""}
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          >
            ...
            >
              <path
                d="M14.5315 12.0158C14.5315 13.405 13.4192 14.5447 12.0003 14.5447C10.5814 14.5447 9.46916 13.405 9.46916 12.0158C9.46916 10.6265 10.5814 9.48682 12.0003 9.48682C13.4192 9.48682 14.5315 10.6265 14.5315 12.0158Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M18.8475 19.3418L18.1189 18.6141C17.4768 17.9726 17.2023 17.0378 17.3718 16.1557C17.5413 15.2736 18.1345 14.5447 18.9663 14.2258L20.0094 13.842C21.0333 13.4673 21.6548 12.3893 21.2801 11.3654L20.8913 10.2307C20.5166 9.20679 19.4386 8.5853 18.4147 8.95998L17.3716 9.34377C16.5398 9.66266 15.9466 10.3916 15.7771 11.2737C15.6076 12.1558 15.8821 13.0906 16.5242 13.7321L17.2528 14.4598"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M5.15247 4.68987L5.88107 5.41753C6.52317 6.05902 6.79767 6.99386 6.62817 7.87595C6.45867 8.75804 5.86548 9.48693 5.03368 9.80582L3.99063 10.1896C2.96673 10.5643 2.34524 11.6423 2.71992 12.6662L3.10873 13.7993C3.48341 14.8232 4.56141 15.4447 5.58531 15.07L6.62836 14.6862C7.46016 14.3673 8.05335 13.6384 8.22285 12.7563C8.39235 11.8742 8.11785 10.9394 7.47575 10.2979L6.74715 9.57021"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M12.0002 18.8475L12.0002 17.3941"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M12.0002 6.6377L12.0002 5.15234"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M7.42676 16.5781L6.3837 17.6212"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M17.6191 6.38574L16.5761 7.4288"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M4.68945 7.4288L3.6464 6.38574"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M20.3545 17.6212L19.3114 16.5781"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
