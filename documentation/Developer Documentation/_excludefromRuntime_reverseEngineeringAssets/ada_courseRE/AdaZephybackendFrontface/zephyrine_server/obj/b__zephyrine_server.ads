...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_zephyrine_server" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3807813e#;
   pragma Export (C, u00001, "zephyrine_serverB");
   ...
   u00111 : constant Version_32 := 16#fa60cf7b#;
   pragma Export (C, u00111, "zephyrineS");
   u00112 : constant Version_32 := 16#7133517a#;
   pragma Export (C, u00112, "zephyrine__http_clientB");
   u00113 : constant Version_32 := 16#2d4b3d61#;
   pragma Export (C, u00113, "zephyrine__http_clientS");
   u00114 : constant Version_32 := 16#96a20755#;
   pragma Export (C, u00114, "ada__strings__fixedB");
   u00115 : constant Version_32 := 16#11b694ce#;
   pragma Export (C, u00115, "ada__strings__fixedS");
   u00116 : constant Version_32 := 16#203d5282#;
   pragma Export (C, u00116, "ada__strings__mapsB");
   u00117 : constant Version_32 := 16#6feaa257#;
   pragma Export (C, u00117, "ada__strings__mapsS");
   u00118 : constant Version_32 := 16#b451a498#;
   pragma Export (C, u00118, "system__bit_opsB");
   u00119 : constant Version_32 := 16#bd85f768#;
   pragma Export (C, u00119, "system__bit_opsS");
   u00120 : constant Version_32 := 16#5b4659fa#;
   pragma Export (C, u00120, "ada__charactersS");
   u00121 : constant Version_32 := 16#cde9ea2d#;
   pragma Export (C, u00121, "ada__characters__latin_1S");
   u00122 : constant Version_32 := 16#d053aba9#;
   pragma Export (C, u00122, "ada__strings__searchB");
   u00123 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00123, "ada__strings__searchS");
   u00124 : constant Version_32 := 16#3c9c2ae7#;
   pragma Export (C, u00124, "interfaces__c__stringsB");
   u00125 : constant Version_32 := 16#bd4557ce#;
   ...
   u00127 : constant Version_32 := 16#5a74c4ef#;
   pragma Export (C, u00127, "zephyrine__c_socketsS");
   ...
   --  system.img_llli%s
   --  zephyrine%s
   --  zephyrine.c_sockets%s
   --  zephyrine.http_client%s
   --  zephyrine.http_client%b
   --  zephyrine_server%b
