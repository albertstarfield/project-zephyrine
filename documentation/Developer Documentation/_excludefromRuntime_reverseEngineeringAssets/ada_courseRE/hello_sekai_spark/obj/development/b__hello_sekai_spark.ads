...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_hello_sekai_spark" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ff6f46d3#;
   pragma Export (C, u00001, "hello_sekai_sparkB");
   ...
   u00111 : constant Version_32 := 16#71fdd28f#;
   pragma Export (C, u00111, "message_generatorB");
   u00112 : constant Version_32 := 16#a62f73b2#;
   pragma Export (C, u00112, "message_generatorS");
