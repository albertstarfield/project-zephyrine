(** * tool_dir_driver_proof.v
     Formal verification record for tool_dir_driver.ads / tool_dir_driver.adb
     SPARK_Mode(off) — subprocess I/O, filesystem operations, external process calls *)

(** ** Verification Context
    Unit: tool_dir_driver (Ada child package)
    SPARK_Mode: off
...
Theorem tool_dir_driver_external_io :
