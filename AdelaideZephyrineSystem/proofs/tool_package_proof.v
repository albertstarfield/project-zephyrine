(** * tool_package_proof.v
     Formal verification record for tool_package.ads / tool_package.adb
     SPARK_Mode(off) — subprocess I/O, filesystem operations, external process calls *)

(** ** Verification Context
    Unit: tool_package (Ada child package)
    SPARK_Mode: off
...
Theorem tool_package_external_io :
