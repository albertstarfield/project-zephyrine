(** * tool_file_edit_proof.v
     Formal verification record for tool_file_edit.ads / tool_file_edit.adb
     SPARK_Mode(off) — subprocess I/O, filesystem operations, external process calls *)

(** ** Verification Context
    Unit: tool_file_edit (Ada child package)
    SPARK_Mode: off
...
Theorem tool_file_edit_external_io :
