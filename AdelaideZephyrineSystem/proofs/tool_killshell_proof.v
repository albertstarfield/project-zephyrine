(** * tool_killshell_proof.v
     Formal verification record for tool_killshell.ads / tool_killshell.adb
     SPARK_Mode(off) — subprocess I/O, filesystem operations, external process calls *)

(** ** Verification Context
    Unit: tool_killshell (Ada child package)
    SPARK_Mode: off
...
Theorem tool_killshell_external_io :
