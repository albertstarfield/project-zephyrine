(* Formal Verification Proof for sd_interface
   Source type: Ada/SPARK
   Source file: src/interfaces/sd_interface.adb
   
   This proof verifies safety properties of the sd_interface module.
...
(* Main safety theorem *)
Lemma sd_interface_safety : no_runtime_errors.
Proof.
...
Lemma sd_interface_type_safe : forall (u : unit_type), type_safety u.
Proof.
  intros u.
  unfold type_safety.
  exact I.
