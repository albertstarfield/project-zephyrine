(* Formal Verification Proof for cronia_scheduler
   Source type: Ada/SPARK
   Source file: src/engine/cronia_scheduler.adb
   
   This proof verifies safety properties of the cronia_scheduler module.
...
(* Main safety theorem *)
Lemma cronia_scheduler_safety : no_runtime_errors.
Proof.
...
Lemma cronia_scheduler_type_safe : forall (u : unit_type), type_safety u.
Proof.
  intros u.
  unfold type_safety.
  exact I.
