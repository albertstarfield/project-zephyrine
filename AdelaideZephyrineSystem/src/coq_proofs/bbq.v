(* Formal Verification Proof for bbq
   Source type: Python
   Source file: src/python/eval/bbq.py
   
   This proof verifies safety properties of the bbq module.
...
(* Main safety theorem *)
Lemma bbq_safety : no_runtime_errors.
Proof.
...
Lemma bbq_type_safe : forall (u : unit_type), type_safety u.
Proof.
  intros u.
  unfold type_safety.
  exact I.
