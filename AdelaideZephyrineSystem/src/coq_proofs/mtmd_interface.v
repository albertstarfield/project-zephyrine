(* Formal Verification Proof for mtmd_interface
   Source type: Ada/SPARK
   Source file: src/interfaces/mtmd_interface.ads
   
   This proof verifies safety properties of the mtmd_interface module.
...
(* Main safety theorem *)
Lemma mtmd_interface_safety : no_runtime_errors.
Proof.
...
Lemma mtmd_interface_type_safe : forall (u : unit_type), type_safety u.
Proof.
  intros u.
  unfold type_safety.
  exact I.
