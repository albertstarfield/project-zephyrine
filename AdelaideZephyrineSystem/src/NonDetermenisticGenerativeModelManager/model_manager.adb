...
package body Model_Manager is
    ...
    begin
        ...
        Models (Snowball_Enaga_ShortNetworkAnswer).Path :=
           To_Unbounded_String ("data/NonDetermenisticGenerativeModel/Qwen3.5-0.8B-Q4_K_M.gguf");
        Models (Snowball_Enaga_Orchestrator).Path :=
           To_Unbounded_String ("data/NonDetermenisticGenerativeModel/Mythos9bHybridq4.gguf");
        Models (Qwen_Embedding).Path :=
           To_Unbounded_String ("data/NonDetermenisticGenerativeModel/Qwen3-Embedding-0.6B-Q8_0.gguf");
        Models (MMProj).Path :=
           To_Unbounded_String ("data/NonDetermenisticGenerativeModel/Mythos9bHybridq4-mmproj-fp16.gguf");
